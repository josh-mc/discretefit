...
Take a discrete distribution with 30 bins (or categories). The probability for the first and second bin is 0.25. The probability for each of the remaining 28 bins is 0.5 / 28 (~0.0179).  

Now take the observed counts of 15 for the first bin, 5 for the second bin, and zero for each of the remaining 28 bins. It's obvious that these observations are very unlikely to be a random sample from the above distribution. However, the Chi-squared test and G^2 test fail to reject the null hypothesis. 
