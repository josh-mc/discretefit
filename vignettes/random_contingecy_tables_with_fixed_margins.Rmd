...
```{r}
plot_speed2 <- function(rsums, csums, title)  {
  
  speed <- bench::mark(min_iterations = 20, 
                       check = FALSE,
                       rcont3_cpp = rcont3_cpp(1000, csums, rsums, 2003920492),
                       rcont32_cpp = rcont32_cpp(1000, csums, rsums, 2003920492),
                       rcont2 = r2dtable(1000, rsums, csums)
                       )
...
# Checking largest row

```{r}
x <- c(1000, 1000, 2000, 12, 31, 21)
...
#rcont32_cpp(1, csums, rsums,  23432)


plot_speed2(rsums, csums, "title")
```

```{r}
x <- c(10000, 21, 29, 8000, 32, 23, 7000, 21, 133)
...
rcont3_cpp(1, csums, rsums, 2789234)
```
...
rcont3_cpp(1, r_sum, c_sum, seed = 1002)
```
...
matt <- matrix(x, ncol = 2, byrow = TRUE)

rsums <- rowSums(matt)
csums <- colSums(matt)

rcont3_cpp(1, rsums, csums, 234234)
```
...
rcont3_cpp(1, csums, rsums, 234234)
```
